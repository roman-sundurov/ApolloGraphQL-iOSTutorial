...
public class LaunchDetailsQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query LaunchDetails($launchId: ID!) { launch(id: $launchId) { __typename id site mission { __typename missionPatch(size: LARGE) name } rocket { __typename name type } isBooked } }"#
    ))
