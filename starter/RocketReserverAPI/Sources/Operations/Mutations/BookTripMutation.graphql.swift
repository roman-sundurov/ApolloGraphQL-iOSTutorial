...
public class BookTripMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation BookTrip($launchId: ID!) { bookTrips(launchIds: [$launchId]) { __typename success message } }"#
    ))
  ...
  public struct Data: RocketReserverAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("bookTrips", BookTrips.self, arguments: ["launchIds": [.variable("launchId")]]),
    ] }
